    ...
    def forward_backward_batch(
        ...
        def loss_func(output, data, meta_info):
            ...
            if not forward_only:
                ...
                if "length_filter_keep_fraction" in meta_info:
                    policy_loss_kwargs["length_filter_keep_fraction"] = meta_info["length_filter_keep_fraction"]
                ...
                if ratio is not None:
                    stats["importance_ratio/mean"] = ratio.mean().detach().item()
                    stats["importance_ratio/max"] = ratio.max().detach().item()
                    stats["importance_ratio/min"] = ratio.min().detach().item()
